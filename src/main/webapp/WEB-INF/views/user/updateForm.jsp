...
<div class="container">
	<form id="profileUpdate" onsubmit="update(${principal.user.id}, event)">
		<div class="form-group">
			...
			<input value="${principal.user.username}" type="text" class="form-control" name="username" readonly/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input value="${principal.user.characterName}" type="text" class="form-control" name="characterName" required="required"/>
		</div>
		<button class="btn btn-primary">회원수정 완료</button>
	</form>
</div>
